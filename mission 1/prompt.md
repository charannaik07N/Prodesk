...
1. Dark mode text visibility:
   Some text is not visible when dark mode is enabled. I have already used classes like `dark:text-gray-200`, but they are not working as expected. Please identify why the text is not changing properly in dark mode and fix the issue.
